"""High-level wrapper around the guide agent LangGraph."""
from __future__ import annotations

import uuid
from typing import Iterable, Sequence

from core.models import DeveloperContext, GuideAgentResult, GuidanceRecommendation, SessionMemory
...
class GuideAgent:
    """Runs the guide agent graph and formats the result."""
